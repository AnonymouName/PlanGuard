...
StageResult StopSignUnprotectedStageCreep::Process(
  ...
  //wk
  const double timeout_sec = (frame->GetUserintercation()->Get_value("scenario", "stop_signal", "Creep_time") > 0.0)?
                              frame->GetUserintercation()->Get_value("scenario", "stop_signal", "Creep_time") :
