...
StageResult ParkAndGoStagePreCruise::Process(
  ...
  //wk
  const double max_steering_percentage = (frame->GetUserintercation()->Get_value("scenario", "open_space_launch", "Permissible_max_steering_percentage") > 0.0)?
                                          frame->GetUserintercation()->Get_value("scenario", "open_space_launch", "Permissible_max_steering_percentage") :
