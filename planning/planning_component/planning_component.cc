...
bool PlanningComponent::Init() {
  ...
  //wk
  if (!user_intercation_.Init()) {return false;}
  return true;
}
...
bool PlanningComponent::Proc(
  ...
  //wk
  user_intercation_.Proc();

  ADCTrajectory adc_trajectory_pb;
  planning_base_->RunOnce(local_view_, &adc_trajectory_pb, &user_intercation_);
  ...
  //wk
  Update_trajectory(&adc_trajectory_pb);
...
bool PlanningComponent::Update_trajectory(ADCTrajectory* const ptr_trajectory_pb){
