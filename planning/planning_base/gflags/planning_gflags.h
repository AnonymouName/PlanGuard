...
//wk
DECLARE_double(side);
DECLARE_double(is_change_lane);
DECLARE_double(is_borrow_lane);
DECLARE_double(is_e_stop);
DECLARE_double(is_pull_over);
DECLARE_double(more_time);
DECLARE_double(wait);
DECLARE_double(user_ask_change_lane);