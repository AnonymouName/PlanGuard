...
//wk
DEFINE_double(side, 0.0, "road side");
DEFINE_double(is_borrow_lane, 0.0, "borrow lane");
DEFINE_double(is_change_lane, 0.0, "change lane");
DEFINE_double(is_e_stop, 0.0, "e stop");
DEFINE_double(is_pull_over, 0.0, "pull over");
DEFINE_double(more_time, 20.0, "change lane wait");
DEFINE_double(wait, 0.0, "wait");
DEFINE_double(user_ask_change_lane, 0.0, "user_ask_change_lane");