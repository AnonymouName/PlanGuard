...
class ReferenceLineInfo {
 public:
  ...
  //wk
  // std::map<std::string, hdmap::PathOverlap> FirstEncounteredOverlaps_() const{
  //   return first_encounter_overlaps__;
  // }
 ...
 private:
  ...
  //wk
  // std::map<std::string, hdmap::PathOverlap> first_encounter_overlaps__;
  /**
