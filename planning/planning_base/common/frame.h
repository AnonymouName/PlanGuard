...
class Frame {
 public:
  ...
  //wk
  bool ChangeLane(PlanningContext *planning_context, const double x, const double y);
  ...
  //wk
  UserIntercation* const GetUserintercation() const {return user_intercation_;}
 ...
 private:
  ...
  //wk
  UserIntercation* user_intercation_;
